<template>
  <div>
    <Modal :isOpen="isOpen" :showModal="showModal">
      ...
      <div
        class="mx-auto grid grid-cols-12 md:grid-cols-20 grid-rows-[250px_minmax(100px,_3fr)] md:grid-rows-[250px_minmax(50px,_3fr)] gap-2"
      >
        <div
          class="flex align-middle mx-auto col-start-5 row-start-3 md:col-start-1 md:row-start-1 inset-y-0 left-0 w-6 top-30 left-20 m-0"
        >
          <CIcon
        ...
        <div
          class="col-auto col-start-2 col-end-12 md:col-start-2 md:col-end-11 row-start-1"
        >
          <img
            width="1000"
            height="1000"
        ...
        <div
          class="col-span-12 row-start-2 md:row-start-1 md:col-start-11 md:col-span-9"
        >
          <!-- <p class="text-xl text-center">
          created on {{ this.portfolioModalValue.year }}
        </p> -->
          <p class="mt-2 mb-2 text-xl body-font font-sans">
            {{ portfolioModalValue.description }}
          </p>
        ...
        <div
          class="flex align-middle mx-auto row-start-3 col-start-8 md-col-start-1 md:col-span-1 md:row-start-1 inset-y-0 left-0 w-6 top-30 left-20 m-0"
        >
          <CIcon
    ...
    <div
      class="mx-auto px-6 py-8 grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 justify-items-center lg:container"
    >
      <div
      ...
      >
        ...
        <div class="px-6 py-4">
          ...
          <p
            class="text-gray-700 text-base body-font font-sans text-justify tracking-normal"
          >
