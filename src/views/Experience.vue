<template>
  <h1 class="font-bold text-3xl text-center">Experience</h1>
  <!-- <swiper :navigation="true" :modules="modules" class="mySwiper4">
    <swiper-slide>
...
export default {
  ...
  methods: {
    ...
    //     this.$refs.mySwiper1.$el.swiper.slideTo(this.$refs.mySwiper2.$el.swiper.activeIndex)
    //   },
    // navigationNext() {
